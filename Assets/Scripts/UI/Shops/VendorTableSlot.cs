...
namespace Shops
{
    public class VendorTableSlot : MonoBehaviour, IItemHolder, IDragContainer<InventoryItem>, IPointerClickHandler
    {
        // CONFIG

        [SerializeField] InventoryItemIcon icon = null;
        [SerializeField] SlotType slotType = SlotType.VendorTable;
        ...
        void IPointerClickHandler.OnPointerClick(PointerEventData eventData)
        {
            ...
            RemoveItems(number);
            shopper.AddToFirstEmptySlot(SlotType.VendorBag, item, number);
