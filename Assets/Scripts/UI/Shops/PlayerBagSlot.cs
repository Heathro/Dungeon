...
namespace Shops
{
    public class PlayerBagSlot : MonoBehaviour, IItemHolder, IDragContainer<InventoryItem>, IPointerClickHandler
    {
        // CONFIG

        [SerializeField] InventoryItemIcon icon = null;
        [SerializeField] SlotType slotType = SlotType.PlayerBag;
        ...
        void IPointerClickHandler.OnPointerClick(PointerEventData eventData)
        {
            ...
            RemoveItems(number);
            shopper.AddToFirstEmptySlot(SlotType.PlayerTable, item, number);
